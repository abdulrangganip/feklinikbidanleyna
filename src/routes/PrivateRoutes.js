    ...
    <Routes>
      {role && role.toUpperCase() === ROLE_NAME.ADMIN ? (
        <>
          ...
          <Route
            path="/data-pasien"
            element={<DataPasien user={user} role={role} />}
          />
          <Route
            path="/data-pasien-anak"
            element={<DataPasienAnak user={user} role={role} />}
          />
          ...
          <Route
            path="/detail-data-pasienAnak"
            element={<DetailDataPasienAnak />}
          />
