...
const DataPasien = (props) => {
  ...
  const getListPasien = async (id) => {
    try {
      const response = await axios.get(
        `https://f081-140-213-11-117.ngrok-free.app/api/getpasien/ibu/${id}`
      );
      const data = response.data?.data;
      ...
      data.keluarga.UMUR_SUAMI = currentDate.diff(
        moment(data.keluarga.TANGGAL_LAHIR_SUAMI, "YYYY-MM-DD"),
        "year"
      );
          ...
          <div className="card-body grid grid-cols-2 gap-x-5">
            ...
            <div className="flex flex-col gap-y-5">
              ...
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien ? detailPasien.PEKERJAAN : "-"}
                </label>
              </div>
              ...
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien ? detailPasien.pendidikan_terakhir.NAMA : "-"}
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="card-body grid grid-cols-2 gap-x-5">
            <div className="flex flex-col gap-y-5">
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien ? detailPasien.keluarga.NAMA_SUAMI : "-"}
                </label>
              </div>
              ...
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien ? detailPasien.keluarga.UMUR_SUAMI : "-"}
                </label>
              </div>
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien
                    ? detailPasien.keluarga.TEMPAT_LAHIR_SUAMI
                    : "-"}
                </label>
              </div>
              ...
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien
                    ? detailPasien.keluarga.TANGGAL_LAHIR_SUAMI
                    : "-"}
                </label>
              </div>
              ...
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien
                    ? listDataAgama
                      ? listDataAgama[detailPasien.keluarga.AGAMA_SUAMI - 1]
                          .NAMA
                      : "-"
                    : "-"}
                </label>
            ...
            <div className="flex flex-col gap-y-5">
                ...
                <label className="input input-info">
                  {detailPasien
                    ? listDataPendidikanTerakhir
                      ? listDataPendidikanTerakhir[
                          detailPasien.keluarga.PENDIDIKAN_SUAMI - 1
                        ].NAMA
                      : "-"
                    : "-"}
                </label>
              ...
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien ? detailPasien.keluarga.PEKERJAAN_SUAMI : "-"}
                </label>
              </div>
              ...
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien ? detailPasien.keluarga.GOL_DARAH_SUAMI : "-"}
                </label>
              </div>
              <div className="grid grid-cols-2">
                <label className="font-bold">JUMLAH ANAK </label>
                <label className="input input-info">
                  {detailPasien ? detailPasien.keluarga.JUMLAH_ANAK : "-"}
                </label>
              </div>
              ...
              <div className="grid grid-cols-2">
                ...
                <label className="input input-info">
                  {detailPasien
                    ? detailPasien.keluarga.UMUR_ANAK_TERAKHIR
                    : "-"}
                </label>
              </div>
            </div>
